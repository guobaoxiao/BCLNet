...
data_arg.add_argument(
    "--data_tr", type=str, default=r'D:/dataset/hdf5/yfcc-sift-2000-test.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default=r'D:/dataset/yfcc/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default=r'D:/dataset/hdf5/yfcc-sift-2000-test.hdf5', help=""
...
test_arg.add_argument(
    "--model_path", type=str, default='../model/yfcc/', help=""
